...
export interface ApiFurnitureCategoryFurnitureCategory
  ...
  attributes: {
    ...
    >;
    parent_furniture_category: Schema.Attribute.Relation<
      'oneToOne',
      'api::furniture-category.furniture-category'
    >;
...
export interface ApiReferenceCategoryReferenceCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'reference_categories';
  info: {
    displayName: 'Reference category';
    pluralName: 'reference-categories';
    singularName: 'reference-category';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiReferenceReference extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    PhraseImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::reference-category.reference-category': ApiReferenceCategoryReferenceCategory;
